...
> **状态：v1.5.0-alpha** — 双范式一体化开发管理工具：**SDD 正本**(sdd-core/input/prd/phase 4 技能 + 5 规则 + 3 守门 agent + 8 个 `/sdd-*` slash command) + **OpenSpec 可选 hook 默认实现**(7 个 `/openspec-*` slash command + 守卫 hook)。
