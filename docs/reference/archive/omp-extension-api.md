...
本文档是 sdd-pack 项目实施「**Omp Slash Commands**」(方案 A，详见 PRD [`2026-06-30-sdd-extension.md`](../../prd/archive/2026-06-30-sdd-extension.md)) 时的**一手 omp 官方文档摘要**。所有结论均带可点击的官方/源码锚点；当 omp 上游文档演进时，以官方文档为准，本文件仅作本仓库实施期的快速参考。
...
详见 [PRD 2026-06-30-sdd-extension.md](../../prd/archive/2026-06-30-sdd-extension.md) §3 模块拓扑。
